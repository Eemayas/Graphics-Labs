...
function(do_fetch)
  ...
  execute_process(
    COMMAND "C:/src/Git/cmd/git.exe" --git-dir=.git fetch --tags --force "origin"
...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "C:/src/Git/cmd/git.exe" --git-dir=.git rev-parse "${ref}^0"
    WORKING_DIRECTORY "E:/6th sem/Graphics/build/_deps/glm-src"
...
execute_process(
  COMMAND "C:/src/Git/cmd/git.exe" --git-dir=.git show-ref "bf71a834948186f4097caa076cd2663c69a10e1e"
  WORKING_DIRECTORY "E:/6th sem/Graphics/build/_deps/glm-src"
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "C:/src/Git/cmd/git.exe" --git-dir=.git symbolic-ref -q HEAD
    WORKING_DIRECTORY "E:/6th sem/Graphics/build/_deps/glm-src"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "C:/src/Git/cmd/git.exe" --git-dir=.git for-each-ref "--format=%(upstream:short)" "${current_branch}"
      WORKING_DIRECTORY "E:/6th sem/Graphics/build/_deps/glm-src"
...
execute_process(
  COMMAND "C:/src/Git/cmd/git.exe" --git-dir=.git status --porcelain
  WORKING_DIRECTORY "E:/6th sem/Graphics/build/_deps/glm-src"
  RESULT_VARIABLE error_code
...
if(need_stash)
  execute_process(
    COMMAND "C:/src/Git/cmd/git.exe" --git-dir=.git stash save --quiet;--include-untracked
    WORKING_DIRECTORY "E:/6th sem/Graphics/build/_deps/glm-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "C:/src/Git/cmd/git.exe" --git-dir=.git checkout "${checkout_name}"
    WORKING_DIRECTORY "E:/6th sem/Graphics/build/_deps/glm-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
else()
  execute_process(
    COMMAND "C:/src/Git/cmd/git.exe" --git-dir=.git rebase "${checkout_name}"
    WORKING_DIRECTORY "E:/6th sem/Graphics/build/_deps/glm-src"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "C:/src/Git/cmd/git.exe" --git-dir=.git rebase --abort
      WORKING_DIRECTORY "E:/6th sem/Graphics/build/_deps/glm-src"
    )
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      if(need_stash)
        execute_process(
          COMMAND "C:/src/Git/cmd/git.exe" --git-dir=.git stash pop --index --quiet
          WORKING_DIRECTORY "E:/6th sem/Graphics/build/_deps/glm-src"
          )
      endif()
      message(FATAL_ERROR "\nFailed to rebase in: 'E:/6th sem/Graphics/build/_deps/glm-src'."
    ...
    execute_process(
      COMMAND "C:/src/Git/cmd/git.exe" --git-dir=.git tag -a
...
if(need_stash)
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "C:/src/Git/cmd/git.exe" --git-dir=.git reset --hard --quiet
      WORKING_DIRECTORY "E:/6th sem/Graphics/build/_deps/glm-src"
    )
    execute_process(
      COMMAND "C:/src/Git/cmd/git.exe" --git-dir=.git stash pop --quiet
      WORKING_DIRECTORY "E:/6th sem/Graphics/build/_deps/glm-src"
      RESULT_VARIABLE error_code
    )
    if(error_code)
      ...
      execute_process(
        COMMAND "C:/src/Git/cmd/git.exe" --git-dir=.git reset --hard --quiet ${head_sha}
        WORKING_DIRECTORY "E:/6th sem/Graphics/build/_deps/glm-src"
      )
      execute_process(
        COMMAND "C:/src/Git/cmd/git.exe" --git-dir=.git stash pop --index --quiet
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'E:/6th sem/Graphics/build/_deps/glm-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
