...
std::array<std::array<float, 2>, 6> triangleCircle(float cx, float cy, float r)
{
    ...
    tempPointsArray[0] = drawCirclePartlyPoints(vertices[0][0], vertices[0][1], 20, 120, 60, 100, white);
    tempPointsArray[1] = drawCirclePartlyPoints(vertices[1][0], vertices[1][1], 20, 0, 300, 100, white);
    tempPointsArray[2] = drawCirclePartlyPoints(vertices[2][0], vertices[2][1], 20, 240, 180, 100, white);
    ...
    glVertex2f(vertices[0][0], vertices[0][1] + 25);
    glVertex2f(vertices[1][0] + 25, vertices[1][1] - 20);

    glVertex2f(vertices[1][0] + 25, vertices[1][1] - 15);
    glVertex2f(vertices[2][0] - 25, vertices[2][1] - 15);
